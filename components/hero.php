<div lc-helper="background" class="container-fluid py-5 mb-4 d-flex justify-content-center" style="  background-image: url('https://images.unsplash.com/photo-1519681393784-d120267933ba?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=1124&amp;q=100');
    ...
    border: 1px solid rgba(209, 213, 219, 0.3);">
        <div class="lc-block">
            <div editable="rich">
                <h2 class="fw-bolder display-3"><?php echo get_theme_mod('hero_title', 'Blog Home Page Heading'); ?>
                </h2>
            </div>
        </div>
        <div class="lc-block col-md-8">
            <div editable="rich">
                <p class="lead"><?php echo get_theme_mod('hero_desc', 'Default description text'); ?>
                </p>
            </div>
        </div>
        <div class="lc-block">
            <a class="btn btn-dark" href="#" role="button"><?php echo get_theme_mod('hero_btn', 'Button Label') ?></a>
        </div>
    </div>
</div>